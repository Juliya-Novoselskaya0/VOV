...
echo '
	...
	<img id='.$_POST['i_id'].' src='.$row["animation"].' class="icon_anim icon" style="width:15%; right:0px; bottom:0px; top:'.$coords_array[1].'px; left:'.$coords_array[0].'px">	
					<img class="close-btn" src="images/close.png" onclick="PopUpHide()"/>			
	</div>
	</div>';
